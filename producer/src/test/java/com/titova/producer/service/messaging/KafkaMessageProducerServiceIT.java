package com.titova.producer.service.messaging;

import com.titova.producer.service.messaging.event.OrderSendEvent;
import com.titova.producer.service.messaging.service.KafkaMessagingService;
import com.titova.producer.service.messaging.util.FakeOrder;
...
public class KafkaMessageProducerServiceIT {
    ...
    public void it_should_send_order_event() {
        ...
        assertEquals(order.getFirstName(), records.iterator().next().value().getFirstName());
        assertEquals(order.getLastName(), records.iterator().next().value().getLastName());
