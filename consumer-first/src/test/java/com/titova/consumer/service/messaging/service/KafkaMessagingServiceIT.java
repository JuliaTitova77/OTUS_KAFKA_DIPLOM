package com.titova.consumer.service.messaging.service;

import com.titova.consumer.domain.Order;
import com.titova.consumer.domain.repository.OrdersRepository;
import com.titova.consumer.service.messaging.event.OrderEvent;
import com.titova.consumer.service.messaging.service.util.FakeOrder;
...
class KafkaMessagingServiceIT {
    ...
    void save_order() throws InterruptedException {
        ...
        assertEquals(orderFromDB.getFirstName(), order.getFirstName());
        assertEquals(orderFromDB.getLastName(), order.getLastName());
