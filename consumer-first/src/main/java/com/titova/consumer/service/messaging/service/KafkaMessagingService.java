...
import com.titova.consumer.service.OrderService;
...
public class KafkaMessagingService {
    ...
    @Transactional
    @KafkaListener(topics = topicCreateOrder, groupId = kafkaConsumerGroupId, properties = {"spring.json.value.default.type=com.titova.consumer.service.messaging.event.OrderEvent"})
